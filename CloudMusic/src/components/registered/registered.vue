  ...
  <div class="registered-box">
    <div class="personal-form">
      <div class="registered-wrap">
            ...
            <ValidationObserver ref="form" v-slot="{ handleSubmit }">
              <form @submit.prevent="handleSubmit(onSubmit)">
                ...
                <button type="submit" class="btn" :class="{'disabled': disabledButton}" :disabled="disabledButton">
                  <span v-if="!disabledButton">注册</span>
        ...
        <div class="btn-tex"><span @click="registeredPage">返回登陆</span></div>
      </div>
    </div>
...
<script>
// import { registeredPhone } from 'api'
...
//         registeredPhone({phone: this.formTel, password: this.formPassword}).then((res) => {
